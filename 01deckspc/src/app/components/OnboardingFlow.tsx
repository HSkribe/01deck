...
const GEN_STEPS: GenStep[] = [
  ...
  { label: 'Generating cryptographic identity hash', detail: 'SHA-3 fingerprint computed', duration: 700 },
...
export function OnboardingFlow() {
  ...
  const buildAgent = (portrait: string): Agent => {
    ...
    return {
      ...
      memoryNotes: 'Memory mode: always_on. Continuously learning from user interactions and evolving with the 01ai ecosystem.',
      online: true,
        ...
        {screen === 5 && (
          ...
          >
            ...
            <p className="text-sm mb-6 text-center" style={{ color: 'rgba(255,255,255,0.4)' }}>
              Your agent's unique visual identity, generated from their identity signature.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-sm mb-8" style={{ color: 'rgba(255,255,255,0.4)' }}>
                ...
                always-on memory, and your custom directive.
              </p>
            </motion.div>
