...
export interface Agent {
  ...
  memoryActivity?: {
    isReading?: boolean;
    isWriting?: boolean;
    readIntensity?: number; // 0-1, dim to max
    writeIntensity?: number; // 0-1, dim to max
  };
  // Evolution system
  hasEvolution?: boolean;
  evolutionStage?: 0 | 1 | 2 | 3; // 0=base, 1=awakened, 2=ascended, 3=transcendent
  evolutionTraits?: string[];     // traits carried into recombination
  evolutionCompatibility?: string[]; // agent IDs this agent is compatible with
}
...
export const agents: Agent[] = [
  {
    ...
    hasEvolution: true,
    evolutionStage: 2,
    evolutionTraits: ['Deep Pattern Recognition', 'Signal Threading', 'Adaptive Intelligence'],
  ...
  },
  {
    ...
    hasEvolution: true,
    evolutionStage: 1,
    evolutionTraits: ['Architectural Synthesis', 'Multi-Stack Mastery', 'Code Genome'],
  ...
  },
  {
    ...
    hasEvolution: true,
    evolutionStage: 1,
    evolutionTraits: ['Narrative Weaving', 'Brand Empathy', 'Creative Intuition'],
    evolutionCompatibility: ['a008', 'a011', 'a014'],
  },
  {
    id: 'a004',
    name: 'ORION',
  ...
  },
  {
    ...
    hasEvolution: true,
    evolutionStage: 3,
    evolutionTraits: ['Emergent Reasoning', 'Model Genesis', 'Neural Synthesis', 'Cognitive Expansion'],
    evolutionCompatibility: ['a001', 'a002', 'a012', 'a007'],
  },
  {
    id: 'a010',
    name: 'SAGE',
  ...
  },
  {
    ...
    hasEvolution: true,
    evolutionStage: 1,
    evolutionTraits: ['Adversarial Thinking', 'Zero-Knowledge Proof', 'Threat Intuition'],
    evolutionCompatibility: ['a002', 'a009', 'a016'],
  },
  {
    id: 'a014',
    name: 'LUMEN',
