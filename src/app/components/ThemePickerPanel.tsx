...
export function ThemePickerPanel() {
  ...
  const accentOptions = ['#ffffff', '#6384ff', '#c864ff', '#f59e0b', '#22c55e', '#ef4444', '#06b6d4'];
          ...
          >
            ...
            <div className="px-6 py-4">
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  <motion.button
                    ...
                    title="Theme file I/O is planned after first release."
                  >
                    <Upload size={13} />
                    Import Soon
                  </motion.button>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  {densityOptions.map(mode => (
                    <motion.button
                      key={mode}
                      onClick={() => setDensityMode(mode)}
                      className="flex-1 py-2 rounded-lg text-xs"
                      style={{
                        background: mode === densityMode ? `${t.accent}15` : t.surface2,
                        border: `1px solid ${mode === densityMode ? t.accent : t.border}`,
                        color: mode === densityMode ? t.text : t.textMuted,
                      }}
                  ...
                  {['Sharp', 'Rounded', 'Holo', 'Minimal', 'Metal', 'Glass'].map(frame => (
                    <motion.button
                      ...
                      style={{
                        ...
                        opacity: frame === 'Rounded' ? 1 : 0.55,
                      }}
                      title={frame === 'Rounded' ? 'Current first-release frame.' : 'Additional frame styles are planned after first release.'}
                    >
                      {frame}
                    </motion.button>
                  ))}
