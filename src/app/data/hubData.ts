...
export const tests: LearnTest[] = [
  // ── LIVE NOW ─────────────────────────────────────────────
  {
    ...
    tagline: 'Quick type snapshot for reflection and discussion.',
    description: 'A guided MBTI-style snapshot with fast interpretation and agent-assisted discussion. Useful for reflection, not a formal clinical instrument.',
    questionCount: 20,
    duration: '6–10 min',
  ...
  },
  {
    id: 't003',
    title: 'IQ Test',
    tagline: 'Quick reasoning challenge across logic and pattern recognition.',
    description: 'A short cognitive snapshot across pattern, verbal, and logic questions. Useful practice and signal, not a standardized IQ certification.',
    questionCount: 12,
    duration: '8–12 min',
  ...
  },
  {
    ...
    tagline: 'Fast trait snapshot across the five major personality dimensions.',
    description: 'A practical Big Five snapshot with plain-language trait feedback and agent-assisted interpretation. Good for self-reflection, not a formal psychometric report.',
    questionCount: 30,
    duration: '8–10 min',
